...
label_3 = Label(root, text="Phonenumber",width=20,font=("bold", 10))
...
Button(root, text='Continue',width=20,bg='green',fg='white',command=submit_and_next).place(x=280,y=430)
Button(root, text='Cancel',width=20,bg='red',fg='white',command=submit_and_next).place(x=60,y=430)
